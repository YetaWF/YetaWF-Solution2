...
// Copied MVC6 RazorViewEngine.cs and modified to create a custom view YetaWFRazorViewEngine
// original formatting kept to simplify diffs
// TODO: Simplify & derive from original RazorViewEngine
...
namespace YetaWF2.Support.ViewEngine {
    ...
    /// </remarks>
    public class YetaWFRazorViewEngine : IRazorViewEngine 
    {
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            {
                throw new ArgumentException("No ViewLocationFormat");
            ...
            {
                throw new ArgumentException("No AreaViewLocationFormats");
        ...
        public RazorPageResult FindPage(ActionContext context, string pageName)
        {
            ...
            {
                throw new ArgumentException("pageName null or empty");
            }
        ...
        public RazorPageResult GetPage(string executingFilePath, string pagePath)
        {
            ...
            {
                throw new ArgumentException("pagePath null or empty");
            }
        ...
        public ViewEngineResult FindView(ActionContext context, string viewName, bool isMainPage)
        {
            ...
            {
                throw new ArgumentException("viewName null or empty");
            }
        ...
        public ViewEngineResult GetView(string executingFilePath, string viewPath, bool isMainPage)
        {
            ...
            {
                throw new ArgumentException("viewPath null or empty");
            }
